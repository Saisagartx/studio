...
export const portfolioData = {
  profile: {
    name: 'Chakali Sai Sagar',
    email: 'saisagar2107@gmail.com',
    phone: '8309844049',
    ...
    education: [
      ...
      {
        institution: 'Sri Mahatma Junior College',
        degree: 'Board of Intermediate Education',
        startDate: '2017',
        endDate: '2019',
        description: 'CGPA: 9.38',
      },
      {
  ...
  avatarUrl: '/__download__/-1215426038/saisagar_profile_pic.jpeg',
};
